...
// Do not edit this file yourself. It was generated on 23:13:41 GMT-0700 (Mountain Standard Time).
...
export interface Query {
   ...
   *    subprojects(projectId: String!): [Subproject!]!
   *
   *    # Retrieves the list of projects for any user by their [uid].
   *    # This query also includes pagination options for easily
   *    # pagination.
   *    projects(uid: String!, pagination: PaginationOptions): [Project!]!
   *
   *    # Returns the access tokens registered to this user.
